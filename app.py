...
def analyze_stock(ticker):
    ...
    features = data[['Close', 'SMA_50', 'EMA_50', 'RSI_3', 'RSI_5', 'RSI_10', 
                     'RSI_14', 'RSI_20', 'MACD', 'Signal', 'OBV', 'CMF', '%K', '%D', 
...
if st.button("Predict"):
    with st.spinner(f"Analyzing {ticker}..."):
        ...
        if result[1] is not None:  # If the analysis was successful
            ticker, last_price, predicted_price, percentage_increase = result
