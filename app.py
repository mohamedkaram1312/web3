...
def compute_indicators(data):
    ...
    data['%K'] = 100 * ((data['Close'] - data['L14']) / (data['H14'] - data['L14'])).fillna(0)
...
start_date = st.date_input("Start Date", pd.to_datetime("2021-10-24"))
end_date = st.date_input("End Date", pd.to_datetime("2024-10-20"))
...
if st.button("Predict"):
    ...
    features = data[['Close', 'SMA_50', 'EMA_50', 'RSI_3', 'RSI_5', 'RSI_10', 'RSI_14', 
                     'RSI_20', 'MACD', 'Signal', 'OBV', 'CMF', '%K', '%D', 
                     'BB_Middle', 'BB_Upper', 'BB_Lower', 'Support', 'Resistance']]
    ...
    last_sequence = features_scaled[-step:]  # Last 10 data points
